                ...
                {/* Common Fields */}
                 <div className="form-control">
                    ...
                    <input 
                        ...
                        className={`input input-bordered ${!isEditing && 'input-ghost pl-0 border-none'}`} 
                        disabled={!isEditing}
                    />
                </div>
                    ...
                    <>
                        ...
                        <div className="form-control md:col-span-2">
                             ...
                             <textarea 
                                ...
                                value={formData.bio || ''} 
                                onChange={handleChange} 
                                className={`textarea textarea-bordered h-24 ${!isEditing && 'textarea-ghost pl-0 border-none resize-none'}`}
                                disabled={!isEditing}
                         ...
                         <div className="form-control md:col-span-2">
                            <label className="label font-semibold">Experience</label>
                             <textarea 
                                ...
                                onChange={handleChange} 
                                className={`textarea textarea-bordered h-20 ${!isEditing && 'textarea-ghost pl-0 border-none resize-none'}`}
                                disabled={!isEditing}
